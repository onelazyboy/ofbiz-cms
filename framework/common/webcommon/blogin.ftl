...
<head>
    ...
    <link href="/boots/css/app.css" rel="stylesheet"/>

    <link href="/boots/css/animate.css" rel="stylesheet"/>
    <link href="/boots/css/style.css" rel="stylesheet"/>
...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    ...
    <#--<p>. To see it in action.</p>-->
        ...
        <form class="m-t" role="form" name="loginform" action="<@ofbizUrl>login</@ofbizUrl>" method="post">
            ...
            <div class="form-group">
                <input type="password" name="PASSWORD" id="PASSWORD" class="form-control" value="ofbiz"
